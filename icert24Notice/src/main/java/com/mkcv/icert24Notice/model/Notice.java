package com.mkcv.icert24Notice.model;
...
public class Notice {
    ...
    String contents=""; // '내용',
    int hit_cnt = 0; // '조회수',
    String topfix_yn="N"; // '상단고정여부',
    String file_yn="N"; // '첨부파일여부',
    Date reg_dt = new Date(); // '등록일시',
    Long reg_usr_seq=0L; // '등록자 SEQ',
    Date mod_dt; // '수정일시',
    Long mod_usr_seq=0L; // '수정자 SEQ',
    ...
    public String getTopfix_yn() {
        return topfix_yn;
    }

    public void setTopfix_yn(String topfix_yn) {
